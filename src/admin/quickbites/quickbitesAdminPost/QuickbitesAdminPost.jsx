...
import './quickbitesAdminPost.scss'
...
const QuickbitesAdminPost = () => {
  ...
  useEffect(() => {
    const GetPost = async () => {
      const res = await axios.get(`/quickbyte/${path}`)
      setPost(res.data)
  ...
  // Delete quickbyte Post

  const handleDelete = async () => {
    try {
      await axios.delete(`/quickbyte/${path}`, {
  ...
  // Update quickbyte Post

  const handleUpdate = async () => {
    try {
      await axios.put(`/quickbyte/${path}`, {
      ...
      console.log('Unable to Update quickbyte Post')
    }
  }
...
export default QuickbitesAdminPost
